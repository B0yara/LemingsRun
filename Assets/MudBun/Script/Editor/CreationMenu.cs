...
namespace MudBun
{
  public class CreationMenu
  {
    ...
    */
    ...
    [MenuItem("Assets/Create/MudBun/Locked Mesh Material", priority = 151)]
    public static void CreateStandardMeshMaterial()
    {
      string path = GetSelectedPathOrFallback() + "/MudBun Locked Mesh Material.mat";

      Material mat = new Material(ResourcesUtil.DefaultLockedMeshMaterial);
      if (mat == null)
        return;

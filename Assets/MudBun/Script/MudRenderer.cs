...
namespace MudBun
{
  ...
  public class MudRenderer : MudRendererBase
  {
    ...
    public override Mesh AddCollider(GameObject go, bool async, Mesh mesh = null, bool makeRigidBody = false)
    {
    ...
    public override Mesh AddLockedStandardMesh(GameObject go, bool autoRigging, bool async, Mesh mesh = null)
    {
      #if UNITY_EDITOR
      ...
      Transform [] aBone;
      mesh = GenerateMesh(GeneratedMeshType.Standard, go.transform, out aBone, async, mesh);
      m_doRigging = false;
    ...
    public override void LockMesh(bool autoRigging, bool async, Mesh mesh = null)
    {
      ...
      base.LockMesh(autoRigging, async, mesh);
      ...
      case RenderableMeshMode.MeshRenderer:
        AddLockedStandardMesh(gameObject, autoRigging, async, mesh);
        if (!async)

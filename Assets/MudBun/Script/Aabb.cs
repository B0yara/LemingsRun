...
namespace MudBun
{
  ...
  public struct Aabb
  {
    ...
    {
      Vector3 oldHalfExtentsA = HalfExtents;
      Vector3 newHalfExtents = oldHalfExtentsA;
      newHalfExtents = VectorUtil.Max(newHalfExtents, VectorUtil.Abs(q * new Vector3( oldHalfExtentsA.x,  oldHalfExtentsA.y,  oldHalfExtentsA.z)));
      newHalfExtents = VectorUtil.Max(newHalfExtents, VectorUtil.Abs(q * new Vector3(-oldHalfExtentsA.x,  oldHalfExtentsA.y,  oldHalfExtentsA.z)));
      newHalfExtents = VectorUtil.Max(newHalfExtents, VectorUtil.Abs(q * new Vector3( oldHalfExtentsA.x, -oldHalfExtentsA.y,  oldHalfExtentsA.z)));
      newHalfExtents = VectorUtil.Max(newHalfExtents, VectorUtil.Abs(q * new Vector3( oldHalfExtentsA.x,  oldHalfExtentsA.y, -oldHalfExtentsA.z)));
    ...
    public void Transform(Transform transform)
    {
      ...
      Vector3 halfExtents = VectorUtil.CompMul(HalfExtents, transform.localScale);
      if (transform.parent != null)
        halfExtents = VectorUtil.CompMul(halfExtents, transform.parent.lossyScale);
      Min = -halfExtents;
      Max = halfExtents;

	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 localMudBunSplatPoint5_g29 = MudBunSplatPoint( VertexID5_g29 , PositionLs5_g29 , NormalWs5_g29 , NormalLs5_g29 , TangentWs5_g29 , TangentLs5_g29 , Color5_g29 , EmissionHash5_g29 , Metallic5_g29 , Smoothness5_g29 , Tex5_g29 , TextureWeight5_g29 );
				...
				o.ase_texcoord9.xyz = vertexToFrag20_g29;
				float3 vertexToFrag27_g32 = temp_output_193_21;
				o.ase_texcoord10.xyz = vertexToFrag27_g32;
				
				float3 vertexToFrag11_g29 = (EmissionHash5_g29).xyz;
				o.ase_texcoord11.xyz = vertexToFrag11_g29;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 vertexToFrag27_g32 = IN.ase_texcoord10.xyz;
				float3 VertPos20_g32 = vertexToFrag27_g32;
				float Hash20_g32 = (EmissionHash5_g29).w;
				float AlphaIn20_g32 = (( _Color * vertexToFrag3_g29 )).a;
				...
				float temp_output_197_0 = ( (temp_output_124_0).w * AlphaOut20_g32 );
				float temp_output_119_25 = AlphaThreshold20_g32;
				clip( temp_output_197_0 - temp_output_119_25);
				
				float3 vertexToFrag11_g29 = IN.ase_texcoord11.xyz;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag11_g29 = (EmissionHash5_g29).xyz;
				o.ase_texcoord6.xyz = vertexToFrag11_g29;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 vertexToFrag11_g29 = IN.ase_texcoord6.xyz;
...
/*ASEBEGIN
Version=18100
-1714;262;1403;717;-183.2559;606.017;1.9;True;False
...
Node;AmplifyShaderEditor.FunctionNode;193;0,-352;Inherit;False;Mud Splat;0;;29;1947d49d4d7bb92419410ba0439aa2bc;0;0;15;COLOR;22;FLOAT2;29;FLOAT;24;FLOAT3;27;FLOAT;26;FLOAT;23;FLOAT4;45;FLOAT3;21;FLOAT3;43;FLOAT3;28;FLOAT3;42;FLOAT3;52;FLOAT3;53;FLOAT2;25;FLOAT;57
...
Node;AmplifyShaderEditor.TexturePropertyNode;195;0,96;Inherit;True;Property;_DitherTexture;Dither Texture;12;0;Create;True;0;0;False;0;False;f240bbb7854046345b218811e5681a54;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.IntNode;196;0,320;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;14;0;Create;True;0;0;False;0;False;256;256;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;194;0,416;Inherit;False;Property;_RandomDither;Random Dither;8;1;[Toggle];Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClipNode;198;2176,-368;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=C0B1B77D0FB0D9F4E790CC76E4AD8F5154E53A5B
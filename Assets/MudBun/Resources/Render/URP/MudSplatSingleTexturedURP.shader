	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 localMudBunSplatPoint5_g25 = MudBunSplatPoint( VertexID5_g25 , PositionLs5_g25 , NormalWs5_g25 , NormalLs5_g25 , TangentWs5_g25 , TangentLs5_g25 , Color5_g25 , EmissionHash5_g25 , Metallic5_g25 , Smoothness5_g25 , Tex5_g25 , TextureWeight5_g25 );
				...
				float3 vertexToFrag27_g28 = temp_output_183_21;
				o.ase_texcoord10.xyz = vertexToFrag27_g28;
				...
				#endif
				float3 vertexValue = temp_output_183_21;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float staticSwitch50_g25 = 0.0;
				#else
				float staticSwitch50_g25 = length( vertexToFrag34_g25 );
				#endif
				clip( 0.5 - staticSwitch50_g25);
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g25 ) * ( _Color * vertexToFrag3_g25 ) );
				float localComputeOpaqueTransparency20_g28 = ( 0.0 );
				...
				float2 ScreenPos20_g28 = (( ( computeScreenPos18_g25 / (computeScreenPos18_g25).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g28 = IN.ase_texcoord10.xyz;
				float3 VertPos20_g28 = vertexToFrag27_g28;
				...
				float4 TextureWeight5_g25 = float4( 1,0,0,0 );
				float3 localMudBunSplatPoint5_g25 = MudBunSplatPoint( VertexID5_g25 , PositionLs5_g25 , NormalWs5_g25 , NormalLs5_g25 , TangentWs5_g25 , TangentLs5_g25 , Color5_g25 , EmissionHash5_g25 , Metallic5_g25 , Smoothness5_g25 , Tex5_g25 , TextureWeight5_g25 );
				float Hash20_g28 = (EmissionHash5_g25).w;
				float AlphaIn20_g28 = (( _Color * vertexToFrag3_g25 )).a;
				float AlphaOut20_g28 = 0;
				float AlphaThreshold20_g28 = 0;
				sampler2D DitherNoiseTexture20_g28 = _DitherTexture;
				int DitherNoiseTextureSize20_g28 = _DitherTextureSize;
				int UseRandomDither20_g28 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g28 = _AlphaCutoutThreshold;
				float DitherBlend20_g28 = _Dithering;
				float alpha = AlphaIn20_g28;
				computeOpaqueTransparency(ScreenPos20_g28, VertPos20_g28, Hash20_g28, DitherNoiseTexture20_g28, DitherNoiseTextureSize20_g28, UseRandomDither20_g28 > 0, AlphaCutoutThreshold20_g28, DitherBlend20_g28,  alpha, AlphaThreshold20_g28);
				AlphaOut20_g28 = alpha;
				float temp_output_197_0 = ( (temp_output_124_0).a * AlphaOut20_g28 );
				float temp_output_119_25 = AlphaThreshold20_g28;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 vertexToFrag27_g28 = temp_output_183_21;
				o.ase_texcoord5.xyz = vertexToFrag27_g28;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 computeScreenPos18_g25 = ComputeScreenPos( unityObjectToClipPos17_g25 );
				float2 ScreenPos20_g28 = (( ( computeScreenPos18_g25 / (computeScreenPos18_g25).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g28 = IN.ase_texcoord5.xyz;
				float3 VertPos20_g28 = vertexToFrag27_g28;
...
/*ASEBEGIN
Version=18100
-1714;262;1403;717;-225.1751;551.5733;1.6;True;False
Node;AmplifyShaderEditor.FunctionNode;183;0,-352;Inherit;False;Mud Splat;0;;25;1947d49d4d7bb92419410ba0439aa2bc;0;0;15;COLOR;22;FLOAT2;29;FLOAT;24;FLOAT3;27;FLOAT;26;FLOAT;23;FLOAT4;45;FLOAT3;21;FLOAT3;43;FLOAT3;28;FLOAT3;42;FLOAT3;52;FLOAT3;53;FLOAT2;25;FLOAT;57
Node;AmplifyShaderEditor.TexturePropertyNode;29;384,-640;Inherit;True;Property;_MainTex;Albedo;9;0;Create;False;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;194;0,416;Inherit;False;Property;_RandomDither;Random Dither;10;1;[Toggle];Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;195;0,96;Inherit;True;Property;_DitherTexture;Dither Texture;6;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.IntNode;196;0,320;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;8;0;Create;True;0;0;False;0;False;256;256;0;1;INT;0
...
WireConnection;188;8;183;21
WireConnection;188;10;183;28
ASEEND*/
//CHKSM=10D879573385F3F9FA13AE8987952EC686A16EBF
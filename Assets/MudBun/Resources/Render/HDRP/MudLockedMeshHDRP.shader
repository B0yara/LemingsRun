	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float Hash20_g6 = packedInput.ase_texcoord7.w;
				float Alpha20_g6 = packedInput.ase_color.a;
				...
				computeOpaqueTransparency(ScreenPos20_g6, VertPos20_g6, Hash20_g6, DitherNoiseTexture20_g6, DitherNoiseTextureSize20_g6, UseRandomDither20_g6 > 0, AlphaCutoutThreshold20_g6, DitherBlend20_g6,  Alpha20_g6, AlphaThreshold20_g6);
				float temp_output_20_24 = Alpha20_g6;
				...
				surfaceDescription.Metallic = packedInput.interp03.xy.x;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = (packedInput.ase_texcoord7).xyz;
				surfaceDescription.Smoothness = packedInput.interp03.xy.y;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = inputMesh.uv1.xy;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = inputMesh.ase_texcoord1.xy;
		...
		Pass
		{
						...
						)
			{
				...
				float3 VertPos20_g6 = vertexToFrag27_g6;
				float Hash20_g6 = packedInput.ase_texcoord9.w;
				float Alpha20_g6 = packedInput.ase_color.a;
				float AlphaThreshold20_g6 = 0;
				sampler2D DitherNoiseTexture20_g6 = _DitherTexture;
				int DitherNoiseTextureSize20_g6 = _DitherTextureSize;
				...
				surfaceDescription.Emission = (packedInput.ase_texcoord9).xyz;
				surfaceDescription.Smoothness = packedInput.interp03.xy.y;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_20_24;
...
/*ASEBEGIN
Version=18400
-1835;269;1403;717;1624.788;263.3694;1.651933;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-960,608;Inherit;False;Property;_RandomDither;Random Dither;2;1;[Toggle];Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;22;-960,512;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;4;0;Create;True;0;0;False;0;False;256;256;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;21;-960,288;Inherit;True;Property;_DitherTexture;Dither Texture;3;0;Create;True;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=EF25CF76C490CEEE15F6EA0B54AEFEC8B02CE934
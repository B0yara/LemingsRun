...
Shader "MudBun/Mud Splat Single-Textured (HDRP)"
{
	Properties
	{
		...
		_DitherTextureSize("Dither Texture Size", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 MudBunSplatPoint( int VertexID, out float3 PositionLs, out float3 NormalWs, out float3 NormalLs, out float3 TangentWs, out float3 TangentLs, out float4 Color, out float4 EmissionHash, out float Metallic, out float Smoothness, out float2 Tex, out float4 TextureWeight )
			{
				float4 positionWs;
				float2 metallicSmoothness;
				mudbun_splat_vert(VertexID, positionWs, PositionLs, NormalWs, NormalLs, TangentWs, TangentLs, Color, EmissionHash, metallicSmoothness, Tex, TextureWeight);
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				int VertexID5_g33 = inputMesh.ase_vertexID;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
				float3 TangentLs5_g33 = float3( 0,0,0 );
				float4 Color5_g33 = float4( 0,0,0,0 );
				float4 EmissionHash5_g33 = float4( 0,0,0,0 );
				float Metallic5_g33 = 0.0;
				float Smoothness5_g33 = 0.0;
				float2 Tex5_g33 = float2( 0,0 );
				float4 TextureWeight5_g33 = float4( 1,0,0,0 );
				float3 localMudBunSplatPoint5_g33 = MudBunSplatPoint( VertexID5_g33 , PositionLs5_g33 , NormalWs5_g33 , NormalLs5_g33 , TangentWs5_g33 , TangentLs5_g33 , Color5_g33 , EmissionHash5_g33 , Metallic5_g33 , Smoothness5_g33 , Tex5_g33 , TextureWeight5_g33 );
				float3 temp_output_190_21 = localMudBunSplatPoint5_g33;
				
				float2 vertexToFrag34_g33 = Tex5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag34_g33;
				float4 vertexToFrag3_g33 = Color5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord6 = vertexToFrag3_g33;
				float3 vertexToFrag20_g33 = localMudBunSplatPoint5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag20_g33;
				float3 vertexToFrag27_g34 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag27_g34;
				
				float vertexToFrag2_g33 = Metallic5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag2_g33;
				
				float3 vertexToFrag11_g33 = (EmissionHash5_g33).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag11_g33;
				
				float vertexToFrag14_g33 = Smoothness5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag14_g33;
				...
				inputMesh.normalOS = NormalWs5_g33;
						...
						)
			{
				...
				float2 vertexToFrag34_g33 = packedInput.ase_texcoord5.xy;
				float2 clampResult36_g33 = clamp( ( vertexToFrag34_g33 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g33 = packedInput.ase_texcoord6;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 0.0;
				#else
				float staticSwitch50_g33 = length( vertexToFrag34_g33 );
				#endif
				clip( 0.5 - staticSwitch50_g33);
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * ( _Color * vertexToFrag3_g33 ) );
				float localComputeOpaqueTransparency20_g34 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord7.xyz;
				float4 unityObjectToClipPos17_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos18_g33 = ComputeScreenPos( unityObjectToClipPos17_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g34 = (( ( computeScreenPos18_g33 / (computeScreenPos18_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g34 = packedInput.ase_texcoord8.xyz;
				float3 VertPos20_g34 = vertexToFrag27_g34;
				int VertexID5_g33 = packedInput.ase_texcoord5.z;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
				...
				float4 TextureWeight5_g33 = float4( 1,0,0,0 );
				float3 localMudBunSplatPoint5_g33 = MudBunSplatPoint( VertexID5_g33 , PositionLs5_g33 , NormalWs5_g33 , NormalLs5_g33 , TangentWs5_g33 , TangentLs5_g33 , Color5_g33 , EmissionHash5_g33 , Metallic5_g33 , Smoothness5_g33 , Tex5_g33 , TextureWeight5_g33 );
				float Hash20_g34 = (EmissionHash5_g33).w;
				float AlphaIn20_g34 = (( _Color * vertexToFrag3_g33 )).a;
				float AlphaOut20_g34 = 0;
				float AlphaThreshold20_g34 = 0;
				sampler2D DitherNoiseTexture20_g34 = _DitherTexture;
				int DitherNoiseTextureSize20_g34 = _DitherTextureSize;
				int UseRandomDither20_g34 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g34 = _AlphaCutoutThreshold;
				float DitherBlend20_g34 = _Dithering;
				float alpha = AlphaIn20_g34;
				computeOpaqueTransparency(ScreenPos20_g34, VertPos20_g34, Hash20_g34, DitherNoiseTexture20_g34, DitherNoiseTextureSize20_g34, UseRandomDither20_g34 > 0, AlphaCutoutThreshold20_g34, DitherBlend20_g34,  alpha, AlphaThreshold20_g34);
				AlphaOut20_g34 = alpha;
				float temp_output_194_0 = ( (temp_output_124_0).a * AlphaOut20_g34 );
				float temp_output_119_25 = AlphaThreshold20_g34;
				clip( temp_output_194_0 - temp_output_119_25);
				
				float vertexToFrag2_g33 = packedInput.ase_texcoord5.w;
				
				float3 vertexToFrag11_g33 = packedInput.ase_texcoord9.xyz;
				
				float vertexToFrag14_g33 = packedInput.ase_texcoord7.w;
				
				surfaceDescription.Albedo = temp_output_124_0.rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _Metallic * vertexToFrag2_g33 );

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( vertexToFrag11_g33 * (_Emission).rgb );
				surfaceDescription.Smoothness = ( _Smoothness * vertexToFrag14_g33 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag34_g33 = Tex5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord.xy = vertexToFrag34_g33;
				float4 vertexToFrag3_g33 = Color5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord1 = vertexToFrag3_g33;
				float3 vertexToFrag20_g33 = localMudBunSplatPoint5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag20_g33;
				float3 vertexToFrag27_g34 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag27_g34;
				
				float vertexToFrag2_g33 = Metallic5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord.w = vertexToFrag2_g33;
				
				float3 vertexToFrag11_g33 = (EmissionHash5_g33).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag11_g33;
				
				float vertexToFrag14_g33 = Smoothness5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = vertexToFrag14_g33;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 vertexToFrag34_g33 = packedInput.ase_texcoord.xy;
				float2 clampResult36_g33 = clamp( ( vertexToFrag34_g33 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g33 = packedInput.ase_texcoord1;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 0.0;
				#else
				float staticSwitch50_g33 = length( vertexToFrag34_g33 );
				...
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * ( _Color * vertexToFrag3_g33 ) );
				float localComputeOpaqueTransparency20_g34 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord2.xyz;
				float4 unityObjectToClipPos17_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos18_g33 = ComputeScreenPos( unityObjectToClipPos17_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g34 = (( ( computeScreenPos18_g33 / (computeScreenPos18_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g34 = packedInput.ase_texcoord3.xyz;
				float3 VertPos20_g34 = vertexToFrag27_g34;
				int VertexID5_g33 = packedInput.ase_texcoord.z;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
				...
				float vertexToFrag2_g33 = packedInput.ase_texcoord.w;
				
				float3 vertexToFrag11_g33 = packedInput.ase_texcoord4.xyz;
				
				float vertexToFrag14_g33 = packedInput.ase_texcoord2.w;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag34_g33 = Tex5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = vertexToFrag34_g33;
				float4 vertexToFrag3_g33 = Color5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord2 = vertexToFrag3_g33;
				float3 vertexToFrag20_g33 = localMudBunSplatPoint5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag20_g33;
				float3 vertexToFrag27_g34 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag27_g34;
					...
					)
			{
				...
				float2 vertexToFrag34_g33 = packedInput.ase_texcoord1.xy;
				float2 clampResult36_g33 = clamp( ( vertexToFrag34_g33 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g33 = packedInput.ase_texcoord2;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 0.0;
				#else
				float staticSwitch50_g33 = length( vertexToFrag34_g33 );
				...
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * ( _Color * vertexToFrag3_g33 ) );
				float localComputeOpaqueTransparency20_g34 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord3.xyz;
				float4 unityObjectToClipPos17_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos18_g33 = ComputeScreenPos( unityObjectToClipPos17_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g34 = (( ( computeScreenPos18_g33 / (computeScreenPos18_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g34 = packedInput.ase_texcoord4.xyz;
				float3 VertPos20_g34 = vertexToFrag27_g34;
				int VertexID5_g33 = packedInput.ase_texcoord1.z;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float vertexToFrag14_g33 = Smoothness5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord3.x = vertexToFrag14_g33;
				
				float2 vertexToFrag34_g33 = Tex5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord3.yz = vertexToFrag34_g33;
				float4 vertexToFrag3_g33 = Color5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord4 = vertexToFrag3_g33;
				float3 vertexToFrag20_g33 = localMudBunSplatPoint5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag20_g33;
				float3 vertexToFrag27_g34 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag27_g34;
					...
					)
			{
				...
				float vertexToFrag14_g33 = packedInput.ase_texcoord3.x;
				
				float2 vertexToFrag34_g33 = packedInput.ase_texcoord3.yz;
				float2 clampResult36_g33 = clamp( ( vertexToFrag34_g33 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g33 = packedInput.ase_texcoord4;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 0.0;
				#else
				float staticSwitch50_g33 = length( vertexToFrag34_g33 );
				...
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * ( _Color * vertexToFrag3_g33 ) );
				float localComputeOpaqueTransparency20_g34 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord5.xyz;
				float4 unityObjectToClipPos17_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos18_g33 = ComputeScreenPos( unityObjectToClipPos17_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g34 = (( ( computeScreenPos18_g33 / (computeScreenPos18_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g34 = packedInput.ase_texcoord6.xyz;
				float3 VertPos20_g34 = vertexToFrag27_g34;
				int VertexID5_g33 = packedInput.ase_texcoord3.w;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float2 vertexToFrag34_g33 = Tex5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xy = vertexToFrag34_g33;
				float4 vertexToFrag3_g33 = Color5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag3_g33;
				float3 vertexToFrag20_g33 = localMudBunSplatPoint5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag20_g33;
				float3 vertexToFrag27_g34 = temp_output_190_21;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag27_g34;
				
				float vertexToFrag2_g33 = Metallic5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag2_g33;
				
				float3 vertexToFrag11_g33 = (EmissionHash5_g33).xyz;
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag11_g33;
				
				float vertexToFrag14_g33 = Smoothness5_g33;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = vertexToFrag14_g33;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 vertexToFrag34_g33 = packedInput.ase_texcoord7.xy;
				float2 clampResult36_g33 = clamp( ( vertexToFrag34_g33 + float2( 0.5,0.5 ) ) , float2( 0,0 ) , float2( 1,1 ) );
				float4 vertexToFrag3_g33 = packedInput.ase_texcoord8;
				#ifdef MUDBUN_QUAD_SPLATS
				float staticSwitch50_g33 = 0.0;
				#else
				float staticSwitch50_g33 = length( vertexToFrag34_g33 );
				...
				float4 temp_output_124_0 = ( tex2D( _MainTex, clampResult36_g33 ) * ( _Color * vertexToFrag3_g33 ) );
				float localComputeOpaqueTransparency20_g34 = ( 0.0 );
				float3 vertexToFrag20_g33 = packedInput.ase_texcoord9.xyz;
				float4 unityObjectToClipPos17_g33 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g33));
				float4 computeScreenPos18_g33 = ComputeScreenPos( unityObjectToClipPos17_g33 , _ProjectionParams.x );
				float2 ScreenPos20_g34 = (( ( computeScreenPos18_g33 / (computeScreenPos18_g33).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g34 = packedInput.ase_texcoord10.xyz;
				float3 VertPos20_g34 = vertexToFrag27_g34;
				int VertexID5_g33 = packedInput.ase_texcoord7.z;
				float3 PositionLs5_g33 = float3( 0,0,0 );
				float3 NormalWs5_g33 = float3( 0,0,0 );
				float3 NormalLs5_g33 = float3( 0,0,0 );
				float3 TangentWs5_g33 = float3( 0,0,0 );
				...
				float vertexToFrag2_g33 = packedInput.ase_texcoord7.w;
				
				float3 vertexToFrag11_g33 = packedInput.ase_texcoord11.xyz;
				
				float vertexToFrag14_g33 = packedInput.ase_texcoord9.w;
...
/*ASEBEGIN
Version=18400
-1714;262;1403;717;1010.023;203.4895;1.686214;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;29;256,-640;Inherit;True;Property;_MainTex;Albedo;10;0;Create;False;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;190;0,-352;Inherit;False;Mud Splat;0;;33;1947d49d4d7bb92419410ba0439aa2bc;0;0;15;COLOR;22;FLOAT2;29;FLOAT;24;FLOAT3;27;FLOAT;26;FLOAT;23;FLOAT4;45;FLOAT3;21;FLOAT3;43;FLOAT3;28;FLOAT3;42;FLOAT3;52;FLOAT3;53;FLOAT2;25;FLOAT;57
Node;AmplifyShaderEditor.SamplerNode;184;640,-640;Inherit;True;Property;_TextureSample1;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;191;0,416;Inherit;False;Property;_RandomDither;Random Dither;9;1;[Toggle];Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;0,512;Inherit;False;Property;_AlphaCutoutThreshold;Alpha Cutout Threshold;5;0;Create;True;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;122;0,608;Inherit;False;Property;_Dithering;Dithering;7;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;124;1040,-400;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;192;0,96;Inherit;True;Property;_DitherTexture;Dither Texture;6;0;Create;True;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.IntNode;193;0,320;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;8;0;Create;True;0;0;False;0;False;0;0;0;1;INT;0
Node;AmplifyShaderEditor.ComponentMaskNode;133;1248,-352;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;119;576,-32;Inherit;False;Mud Alpha Threshold;-1;;34;926535703f4c32948ac1f55275a22bf0;0;9;8;FLOAT2;0,0;False;15;FLOAT3;0,0,0;False;18;FLOAT;0;False;22;FLOAT;0;False;19;SAMPLER2D;0;False;26;INT;256;False;9;INT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;2;FLOAT;24;FLOAT;25
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;194;1504,-352;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClipNode;185;1760,-416;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;86;2048,-384;Float;False;True;-1;2;MudBun.MudSplatSingleTexturedMaterialEditor;0;2;MudBun/Mud Splat Single-Textured (HDRP);53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;4;Include;;False;;Native;Define;SHADER_GRAPH;False;;Custom;Include;../../../Shader/Render/ShaderCommon.cginc;False;;Custom;Include;../../../Shader/Render/SplatCommon.cginc;False;;Custom;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;0;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
...
WireConnection;184;0;29;0
WireConnection;184;1;190;29
WireConnection;124;0;184;0
...
WireConnection;185;2;119;25
WireConnection;86;0;185;0
...
ASEEND*/
//CHKSM=481B4E88CFCCAB091F4F04B2A944092AA700359D
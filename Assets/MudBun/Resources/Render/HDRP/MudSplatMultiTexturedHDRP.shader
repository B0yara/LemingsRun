	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 localMudBunSplatPoint5_g32 = MudBunSplatPoint( VertexID5_g32 , PositionLs5_g32 , NormalWs5_g32 , NormalLs5_g32 , TangentWs5_g32 , TangentLs5_g32 , Color5_g32 , EmissionHash5_g32 , Metallic5_g32 , Smoothness5_g32 , Tex5_g32 , TextureWeight5_g32 );
						...
						)
			{
				...
				float staticSwitch50_g32 = 0.0;
				#else
				float staticSwitch50_g32 = length( vertexToFrag34_g32 );
				#endif
				clip( 0.5 - staticSwitch50_g32);
				float4 temp_output_124_0 = ( ( ( ( ( (float)1 > 0.0 ? tex2D( _MainTex, temp_output_23_0_g33 ) : float4( 0,0,0,0 ) ) * break10_g34.x ) + ( ( (float)(int)_UseTex1 > 0.0 ? tex2D( _Tex1, temp_output_23_0_g33 ) : float4( 0,0,0,0 ) ) * break10_g34.y ) + ( ( (float)(int)_UseTex2 > 0.0 ? tex2D( _Tex2, temp_output_23_0_g33 ) : float4( 0,0,0,0 ) ) * break10_g34.z ) + ( ( (float)(int)_UseTex3 > 0.0 ? tex2D( _Tex3, temp_output_23_0_g33 ) : float4( 0,0,0,0 ) ) * break10_g34.w ) ) / ( break10_g34.x + break10_g34.y + break10_g34.z + break10_g34.w ) ) * ( _Color * vertexToFrag3_g32 ) );
				...
				float AlphaIn20_g35 = (( _Color * vertexToFrag3_g32 )).a;
...
/*ASEBEGIN
Version=18400
-1714;262;1403;717;849.1542;452.9692;1.9;True;False
...
Node;AmplifyShaderEditor.FunctionNode;190;0,-352;Inherit;False;Mud Splat;0;;32;1947d49d4d7bb92419410ba0439aa2bc;0;0;15;COLOR;22;FLOAT2;29;FLOAT;24;FLOAT3;27;FLOAT;26;FLOAT;23;FLOAT4;45;FLOAT3;21;FLOAT3;43;FLOAT3;28;FLOAT3;42;FLOAT3;52;FLOAT3;53;FLOAT2;25;FLOAT;57
...
Node;AmplifyShaderEditor.RangedFloatNode;191;0,416;Inherit;False;Property;_RandomDither;Random Dither;8;1;[Toggle];Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;122;0,608;Inherit;False;Property;_Dithering;Dithering;6;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;193;0,320;Inherit;False;Property;_DitherTextureSize;Dither Texture Size;10;0;Create;True;0;0;False;0;False;256;256;0;1;INT;0
Node;AmplifyShaderEditor.TexturePropertyNode;192;0,96;Inherit;True;Property;_DitherTexture;Dither Texture;7;0;Create;True;0;0;False;0;False;f240bbb7854046345b218811e5681a54;f240bbb7854046345b218811e5681a54;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=24C10B10B1DFBE4C690A34BD338B499D2C24DF6D